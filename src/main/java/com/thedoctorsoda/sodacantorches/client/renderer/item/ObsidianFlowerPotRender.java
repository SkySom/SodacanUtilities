...
public class ObsidianFlowerPotRender implements IItemRenderer {
	...
	private void render(ItemStack stack, float x, float y, float z, RenderBlocks renderer) {
		...
		BlockRendererHelper.renderSimpleBlock(ModBlocks.obsidian_flowerpot, 0, renderer);

		OpenGLHelper.translate(-0.5F, -0.5F, -0.5F);
		OpenGLHelper.disableLighting();
		float f3 = 0.1865F;
		IIcon iicon = renderer.getBlockIconFromSide(ModBlocks.obsidian_flowerpot, 0);
		Tessellator.instance.startDrawingQuads();
		renderer.renderFaceXPos(ModBlocks.obsidian_flowerpot, 0 - 0.5F + f3, 0, 0, iicon);
		renderer.renderFaceXNeg(ModBlocks.obsidian_flowerpot, 0 + 0.5F - f3, 0, 0, iicon);
		renderer.renderFaceZPos(ModBlocks.obsidian_flowerpot, 0, 0, 0 - 0.5F + f3, iicon);
		renderer.renderFaceZNeg(ModBlocks.obsidian_flowerpot, 0, 0, 0 + 0.5F - f3, iicon);
		renderer.renderFaceYPos(ModBlocks.obsidian_flowerpot, 0, 0 - 0.5F + f3 + 0.1875F, 0, renderer.getBlockIcon(Blocks.dirt));
