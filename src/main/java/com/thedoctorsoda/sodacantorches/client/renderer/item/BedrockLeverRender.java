...
public class BedrockLeverRender implements IItemRenderer {
	...
	private void render(ItemStack stack, float x, float y, float z, RenderBlocks renderer) {
		...
		BlockRendererHelper.renderSimpleBlock(ModBlocks.bedrock_lever, 0, renderer);
		OpenGLHelper.translate(-0.5, -0.5, -0.5);

		renderer.clearOverrideBlockTexture();

		IIcon icon = renderer.getBlockIconFromSide(ModBlocks.bedrock_lever, 0);
		...
		renderer.renderFaceYPos(ModBlocks.bedrock_lever, 0, 0, 0 + f + f / 2, icon);
		renderer.setRenderBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, 0.6F, 0.5F + f);
		tessellator.setNormal(0.0F, 0.0F, -1.0F);
		renderer.renderFaceZNeg(ModBlocks.bedrock_lever, 0, 0, 0, icon);
		tessellator.setNormal(0.0F, 0.0F, 1.0F);
		renderer.renderFaceZPos(ModBlocks.bedrock_lever, 0, 0, 0, icon);
		tessellator.setNormal(-1.0F, 0.0F, 0.0F);
		renderer.renderFaceXNeg(ModBlocks.bedrock_lever, 0, 0, 0, icon);
		tessellator.setNormal(1.0F, 0.0F, 0.0F);
		renderer.renderFaceXPos(ModBlocks.bedrock_lever, 0, 0, 0, icon);
		tessellator.draw();
